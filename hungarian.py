...
# def main():
    #find_minimum([[7, 6, 2, 9, 2],[6, 2, 1, 3, 9],[5, 6, 8, 9, 5],[6, 8, 5, 8, 6],[9, 5, 6, 4, 7]])
 ...
 #   a = find_minimum([[7.43, 6, 2, 9, 2],[6, 2, 1, 3, 9],[5, 6, 8, 9, 5],[6, 8, 5, 8, 6],[9, 5, 6, 4, 7]])
 #   print(a)
